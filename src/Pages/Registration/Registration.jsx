      ...
      if (imageResult.success) {
        ...
        createUser(userData.email, userData.password)
          ...
          .then(() => {
            ...
            const saveUser = { name: userData.name, email: userData.email, id: userData.id, university: userData.university, address: userData.address };

            fetch('https://campus-connect-server-toushik018.vercel.app/users', {
              method: 'POST',
              headers: {
      ...
      <div className="bg-gray-100 p-8 rounded-lg shadow-lg border border-gray-300">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            {errors.university && (
              <p className="mt-2 text-sm text-red-600">Please enter Your University</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.address && (
              <p className="mt-2 text-sm text-red-600">Please enter Your Address</p>
            )}
          </div>
